...
export const ProdutoCarrinho = (props) => {
    ...
    return (
        ...
        >
            ...
            justifyContent:'center',aliugnItems:'center', marginBottom:'inherit'}}>
            ...
            <Card.Body>
                ...
                <Button
                    onClick={() => addToCart()}
                    className={`${theme? 'bg-dark-primary text-black' : 'bg-light-primary text-black'}d-flex alignt-item-center m-auto border-0`}
                >
